...
<html lang="en">
  <head>
    ...
    <title>Sign in - Sistem Inventaris Barang BANPDM PABAR</title>
    ...
    <div class="page page-center">
      <div class="container container-tight py-4">
       <div class="text-center mb-6">
          <img src="https://ban-pdm.id/assets/images/logo-ban.png" width="100" alt="Logo BAN PDM"
              class="mx-auto mb-3 drop-shadow-md rounded-lg" />
          <h1 class="text-xl font-bold text-gray-800">Sistem Inventaris BAN PDM <br>Papua Barat</h1>
      </div>
            ...
            <form action="{{ route('login.post') }}" method="post" autocomplete="off" novalidate>
              ...
              <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control @error('name')
                    is-invalid
                @enderror" value="{{ old('name') }}" placeholder="" autocomplete="off" />
                @error('name')
              ...
              <div class="mb-2">
                ...
                <div class="input-group input-group-flat">
                  <input type="password" class="form-control @error("password") is-invalid @enderror" name="password" placeholder="" autocomplete="off" />
                  @error('password')
                    <div class="invalid-feedback">{{ $message }}</div>    
                @enderror
