...
@section('content')
    <div class="mb-2">
        <a href="{{ route('category.create') }}" class="btn btn-blue btn-animate-icon btn-animate-icon-rotate">
    ...
    <div class="card">
        <div class="card-body p-0">
            <div id="table-default" data-list class="table-responsive">
                <div class="mb-3">
                    <input type="text" class="search form-control" placeholder="Cari kategori...">
                </div>
                    ...
                    <tbody class="table-tbody"> {{-- ✅ penting: class="list" agar List.js bisa baca --}}
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td class="sort-created_at">{{ $category->created_at->format('d F Y H:i') }}</td>
                                <td class="sort-updated_at">{{ $category->updated_at->format('d F Y H:i') }}</td>
                                <td>
                                    <div class="btn-list flex-nowrap">
                                        <a href="{{ route('category.edit', $category->id) }}" class="btn btn-1"> Edit </a>
                                        {{-- <div class="dropdown">
